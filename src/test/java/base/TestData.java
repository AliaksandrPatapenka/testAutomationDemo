...
public final class TestData {
    ...
    public static final String LANGUAGE_CODE_RUS = System.getProperty("language.rus", "rus1");
    ...
    public  static final String EXPECTED_TEXT_AUTH_SUCCESS = System.getProperty("auth.success", "Exit");
